...
class AnalogClock1 : View {
    ...
    /* renamed from: tf */
    private var f75tf: Typeface? = null
    ...
    fun ttfFont(): Typeface? {
        if (font == "1") {
            try {
                f75tf = Typeface.createFromAsset(context.assets, "a.ttf")
            } catch (e: Exception) {
                e.printStackTrace()
            }
        } else if (font == "2") {
            try {
                f75tf = Typeface.createFromAsset(context.assets, "b.ttf")
            } catch (e2: Exception) {
                e2.printStackTrace()
            }
        } else if (font == "3") {
            try {
                f75tf = Typeface.createFromAsset(context.assets, "c.ttf")
            } catch (e3: Exception) {
                e3.printStackTrace()
            }
        } else if (font == "4") {
            try {
                f75tf = Typeface.createFromAsset(context.assets, "d.ttf")
            } catch (e4: Exception) {
                e4.printStackTrace()
            }
        } else if (font == "5") {
            try {
                f75tf = Typeface.createFromAsset(context.assets, "e.ttf")
            } catch (e5: Exception) {
                e5.printStackTrace()
            }
        } else if (font == "6") {
            try {
                f75tf = Typeface.createFromAsset(context.assets, "f.ttf")
            } catch (e6: Exception) {
                e6.printStackTrace()
            }
        } else if (font == "7") {
            try {
                f75tf = Typeface.createFromAsset(context.assets, "g.ttf")
            } catch (e7: Exception) {
                e7.printStackTrace()
            }
        } else if (font == "8") {
            try {
                f75tf = Typeface.createFromAsset(context.assets, "h.ttf")
            } catch (e8: Exception) {
                e8.printStackTrace()
            }
        } else if (font == "9") {
            try {
                f75tf = Typeface.createFromAsset(context.assets, "i.ttf")
            } catch (e9: Exception) {
                e9.printStackTrace()
            }
        } else if (font == "10") {
            try {
                f75tf = Typeface.createFromAsset(context.assets, "j.ttf")
            } catch (e10: Exception) {
                e10.printStackTrace()
            }
        } else if (font == "11") {
            try {
                f75tf = Typeface.createFromAsset(context.assets, "k.ttf")
            } catch (e11: Exception) {
                e11.printStackTrace()
            }
        } else if (font == "12") {
            try {
                f75tf = Typeface.createFromAsset(context.assets, "l.ttf")
            } catch (e12: Exception) {
                e12.printStackTrace()
            }
        } else if (font == "13") {
            try {
                f75tf = Typeface.createFromAsset(context.assets, "m.ttf")
            } catch (e13: Exception) {
                e13.printStackTrace()
            }
        } else if (font == "14") {
            try {
                f75tf = Typeface.createFromAsset(context.assets, "n.ttf")
            } catch (e14: Exception) {
                e14.printStackTrace()
            }
        } else if (font == "15") {
            try {
                f75tf = Typeface.createFromAsset(context.assets, "o.ttf")
            } catch (e15: Exception) {
                e15.printStackTrace()
            }
        } else if (font == "16") {
            try {
                f75tf = Typeface.createFromAsset(context.assets, "p.ttf")
            } catch (e16: Exception) {
                e16.printStackTrace()
            }
        } else if (font == "17") {
            try {
                f75tf = Typeface.createFromAsset(context.assets, "q.ttf")
            } catch (e17: Exception) {
                e17.printStackTrace()
            }
        } else if (font == "18") {
            try {
                f75tf = Typeface.createFromAsset(context.assets, "r.ttf")
            } catch (e18: Exception) {
                e18.printStackTrace()
            }
        } else if (font == "19") {
            try {
                f75tf = Typeface.createFromAsset(context.assets, "s.ttf")
            } catch (e19: Exception) {
                e19.printStackTrace()
            }
        } else if (font == "20") {
            try {
                f75tf = Typeface.createFromAsset(context.assets, "t.ttf")
            } catch (e20: Exception) {
                e20.printStackTrace()
            }
        }
    ...
    fun clock(canvas: Canvas) {
        ...
        for (i in 0..60) {
            ...
            if (i % 5 == 0) {
                ...
                val f = i2.toFloat()
                val d14 = f76x.toDouble()
                val d15 = (radius.toFloat() * 0.92f).toDouble()
                val d16 = (i.toFloat() / 60.0f * 360.0f - 90.0f).toDouble()
                val cos3 = Math.cos(Math.toRadians(d16))
                java.lang.Double.isNaN(d15)
                java.lang.Double.isNaN(d14)
                val d17 = f77y.toDouble()
                val d18 = (radius.toFloat() * 0.92f).toDouble()
                val sin3 = Math.sin(Math.toRadians(d16))
                java.lang.Double.isNaN(d18)
                java.lang.Double.isNaN(d17)
                canvas.drawLine(
                    f,
                    i4.toFloat(),
                    (d14 + d15 * cos3).toFloat(),
                    (d17 + d18 * sin3).toFloat(),
                    paint!!
                )
            } else {
                val canvas3 = canvas
                ...
                val f2 = i2.toFloat()
                val d19 = f76x.toDouble()
                val d20 = (radius.toFloat() * 0.98f).toDouble()
                val d21 = (i.toFloat() / 60.0f * 360.0f - 90.0f).toDouble()
                val cos4 = Math.cos(Math.toRadians(d21))
                java.lang.Double.isNaN(d20)
                java.lang.Double.isNaN(d19)
                val d22 = f77y.toDouble()
                val d23 = (radius.toFloat() * 0.98f).toDouble()
                val sin4 = Math.sin(Math.toRadians(d21))
                java.lang.Double.isNaN(d23)
                java.lang.Double.isNaN(d22)
                canvas.drawLine(
                    f2,
                    i4.toFloat(),
                    (d19 + d20 * cos4).toFloat(),
                    (d22 + d23 * sin4).toFloat(),
                    paint!!
                )
    ...
    fun minhour(canvas: Canvas) {
        ...
        canvas.save()
        paint!!.color = mincolor
        canvas.drawCircle(f76x, f77y, (radius / 25).toFloat(), paint!!)
    }
    ...
    fun setDisplayHandSec(canvas: Canvas) {
        ...
        java.lang.Double.isNaN(d2)
        java.lang.Double.isNaN(d)
        val f3 = (d + d2 * cos).toFloat()
        val d4 = f77y.toDouble()
        val d5 = (radius.toFloat() * 0.85f).toDouble()
        val sin = Math.sin(Math.toRadians(d3))
        java.lang.Double.isNaN(d5)
        java.lang.Double.isNaN(d4)
        canvas.drawLine(f, f2, f3, (d4 + d5 * sin).toFloat(), paint!!)
        paint!!.strokeWidth = (radius / 25).toFloat()
        val d6 = f76x.toDouble()
        val d7 = (radius.toFloat() * 0.3f).toDouble()
        val cos2 = Math.cos(Math.toRadians(d3))
        java.lang.Double.isNaN(d7)
        java.lang.Double.isNaN(d6)
        val f4 = (d6 - d7 * cos2).toFloat()
        val d8 = f77y.toDouble()
        val d9 = (radius.toFloat() * 0.3f).toDouble()
        val sin2 = Math.sin(Math.toRadians(d3))
        java.lang.Double.isNaN(d9)
        java.lang.Double.isNaN(d8)
        canvas.drawLine(f4, (d8 - d9 * sin2).toFloat(), f76x, f77y, paint!!)
        canvas.drawCircle(f76x, f77y, (radius / 20).toFloat(), paint!!)
    }
